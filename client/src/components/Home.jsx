  ...
  const features = [
    {
      ...
      description:
        "Create professional workshop reports with ease. Upload media, add activities, and generate comprehensive documents.",
    ...
    },
    {
      ...
      description:
        "Build structured content with customizable blocks. Perfect for creating organized and detailed documentation.",
      // path: '/dynamic-block',
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-indigo-600 max-w-2xl mx-auto">
            Create professional documents and reports with our easy-to-use
            templates and tools
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-indigo-600 text-sm mb-4 line-clamp-2"></p>

                {/* Action Buttons */}
                <div className="flex gap-4">
                  <Link
                    to="/templates/sample-report"
